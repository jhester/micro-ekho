...
const SENSE_RESISTOR = 1000;
const I_GAIN = 200;
const V_GAIN = 1;
const V_REF = 1.5;
const ADC_RES = 1024;
const TIMS_TEENSY_PORT = '/dev/cu.usbmodem816861';
const JOSIAH_TEENSY_PORT = '/dev/cu.usbmodem819541';
...
/*** CHANGE THIS FOR TIM ****/
/*** CHANGE THIS FOR TIM ****/
const TEENSY_PORT = JOSIAH_TEENSY_PORT;
...
var port = new SerialPort(TEENSY_PORT, {
  baudrate: 115200,
